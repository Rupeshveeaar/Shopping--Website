...
urlpatterns = [
    ...
    path('changepassword/', auth_views.PasswordChangeView.as_view(template_name='app/passwordchangeform.html' ,
    ...
    auth_views.PasswordResetConfirmView.as_view(template_name='app/password_reset_done_confirm.html',
